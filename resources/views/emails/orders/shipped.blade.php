...
# Yeay, Order Kamu Sudah Dikirim!
Order Terkirim Pada Waktu: <strong>{{\General::datetimeFormat($order->shipment->shipped_at)}}</strong> Kurir Ojol Yang Mengirim: <strong>{{ $order->shipment->track_number }}</strong>
<br>
<br/>
...
| &nbsp;         | Shipping cost | {{ \General::priceFormat($order->discount_amount) }} |
