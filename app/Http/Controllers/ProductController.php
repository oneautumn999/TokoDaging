...
class ProductController extends Controller
{
    public function __construct()
    {
        ...
        $this->data['promos'] = AttributeOption::whereHas('attribute', function ($query){
    ...
    //fitur untuk mengurutkan barang berdasarkan harga
    ...
    //fitur untuk mengurutkan barang berdasarkan attribute promo
    ...
    public function show($slug)
    {
        ...
        if ($product->type == 'configurable') {
            $this->data['promos'] = ProductAttributeValue::getAttributeOptions($product, 'promo')->pluck('text_value', 'text_value');
        }
